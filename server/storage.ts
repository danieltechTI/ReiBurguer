...
const initialProducts: Product[] = [
  {
    ...
    description: "Hambúrguer suculento com carne premium 150g, queijo derretido, alface e tomate frescos. O clássico que não pode faltar!",
    price: 28.90,
    originalPrice: 32.00,
    category: "hamburguer",
    ingredient: "carne",
  ...
  },
  {
    ...
    description: "Hambúrguer com bacon crocante e crocante, queijo cheddar derretido e nosso molho especial da ReiBurguer. Simplesmente irresistível!",
    price: 34.90,
    category: "hamburguer",
    ingredient: "bacon",
  ...
  },
  {
    ...
    description: "Hambúrguer de frango grelhado na hora com alface, tomate e nossa maionese caseira. Opção saudável e saborosa!",
    price: 24.90,
    originalPrice: 28.00,
    category: "hamburguer",
    ingredient: "frango",
  ...
  },
  {
    ...
    description: "Hambúrguer delicioso com grão-de-bico, quinoa e legumes grelhados com perfeição. Para quem curte sabor sem carne!",
    price: 22.90,
    category: "hamburguer",
    ingredient: "vegetariano",
    image: "/assets/generated_images/vegetarian_burger.png",
    images: ["/assets/generated_images/vegetarian_burger.png"],
    featured: true,
    inStock: true,
    specifications: {
      weight: "200g",
  ...
  },
  {
    ...
    description: "Refrigerante geladinho em garrafa de 2L para acompanhar seu hambúrguer favorito. Perfeito para a família!",
    price: 8.90,
    originalPrice: 10.00,
    category: "bebidas",
    ingredient: "vegetariano",
  ...
  },
  {
    ...
    description: "Batata frita crocante com sal especial ReiBurguer. Dourada na fritura perfeita, irresistivelmente gostosa!",
    price: 12.90,
  ...
  },
  {
    ...
    description: "Anéis de cebola crocantes e sequinhos, perfeitos para compartilhar ou saborear sozinho. Textura impecável!",
    price: 14.90,
    category: "acompanhamentos",
    ingredient: "vegetariano",
  ...
  },
  {
    ...
    description: "Lata gelada de refrigerante 350ml. Bebida refrescante perfeita para acompanhar seu pedido!",
    price: 3.50,
    category: "bebidas",
    ingredient: "vegetariano",
  ...
  },
  {
    id: "9",
    name: "Sorvete Sundae",
    description: "Sorvete macio e cremoso com cobertura de calda de chocolate quente e granulado. Doce finalização perfeita!",
    price: 11.90,
    category: "sobremesas",
    ingredient: "vegetariano",
  ...
  },
  {
    id: "10",
    name: "Combo Clássico",
    description: "Hambúrguer Clássico + Batata Frita Grande + Refrigerante 2L. O combo mais escolhido da ReiBurguer!",
    price: 42.90,
    originalPrice: 50.00,
    category: "combos",
    ingredient: "carne",
  ...
  },
  {
    ...
    description: "Milk shake cremoso de morango natural com calda e cobertura de chantilly. Refrescante e saboroso!",
    price: 13.90,
    category: "bebidas",
    ingredient: "vegetariano",
    image: "/assets/generated_images/strawberry_milkshake.png",
    images: ["/assets/generated_images/strawberry_milkshake.png"],
    featured: false,
    inStock: true,
    specifications: {
      weight: "400ml",
  ...
  },
  {
    id: "12",
    name: "Combo Premium",
    description: "Hambúrguer Bacon Premium + Anéis de Cebola + Milk Shake de Morango. Aproveite essa promoção imperdível!",
    price: 54.90,
    originalPrice: 65.00,
    category: "combos",
    ingredient: "bacon",
    image: "/assets/generated_images/premium_burger_combo.png",
    images: ["/assets/generated_images/premium_burger_combo.png"],
    featured: true,
    inStock: true,
    specifications: {
      weight: "600g aprox",
